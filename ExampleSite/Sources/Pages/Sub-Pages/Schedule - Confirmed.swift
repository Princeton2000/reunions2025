...
struct ScheduleConfirmed: StaticPage {
	var title = "Schedule"
	var events: [Event] { let decoder = JSONDecoder(); let data = try! Data(contentsOf: URL(fileURLWithPath: "/Users/jpurnell/Documents/Princeton/Class of 2000/Website/Ignite/ExampleSite/Resources/scheduled-events.json")); let events = try! decoder.decode([Event].self, from: data); return events.sorted(by: {$0.startDate < $1.startDate})}
