...
public struct NavBar: Component {
	...
	func princeton2000() -> String {
		return "<a href=\"/\" class=\"navbar-brand\"><h3 style=\"font-family: princeton_monticello; font-size: calc(1.2rem + .7vw); color: #E77500; line-height: 2rem; margin-bottom: 0rem; text-align: center; class=\"text-center mx-auto\">PRINCETON 2000</h2>"
	}
...
//			}.foregroundStyle(.princetonOrange)
			...
			Link(Text("AG").foregroundStyle(.princetonOrange), target: AnnualGiving())
